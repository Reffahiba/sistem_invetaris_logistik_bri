...
const steps = [
    ...
    { label: "sedang diproses", icon: "/assets/refresh-square-2.png", color: "bg-yellow-400" },
    { label: "sedang diantar", icon: "/assets/send-sqaure-2.png", color: "bg-blue-400" },
    { label: "telah diterima", icon: "/assets/tick-square.png", color: "bg-green-400" },
];
