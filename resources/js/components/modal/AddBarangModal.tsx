    ...
    const handleAddSubmit = async (e: FormEvent) => {
        ...
        try {
            if (
                ...
                newBarangData.stok <= 0 ||
                !newBarangData.satuan
            ) {
                alert(
                    "Nama barang, stok, dan satuan harus diisi dengan benar."
                );
                setIsLoading(false);
                setUploadProgress(0);
                return;
            ...
            formData.append(
                "id_kategori",
                newBarangData.id_kategori
                    ? String(newBarangData.id_kategori)
                    : ""
            );
            ...
            if (uploadedFile) {
                // Menggunakan uploadedFile state untuk mengirim file
                formData.append("gambar_barang", uploadedFile);
            } else if (
                typeof newBarangData.gambar_barang === "string" &&
                newBarangData.gambar_barang
            ) {
                formData.append(
                    "gambar_barang_url",
                    newBarangData.gambar_barang
                ...
                <div className="flex-grow overflow-y-auto pr-4 -mr-4">
                    <form onSubmit={handleAddSubmit} className="grid gap-4">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="relative">
                                <select
                                    id="id_kategori"
                                    className="w-full px-3 py-2 border border-gray-300 rounded-sm appearance-none focus:outline-none focus:ring-0.5rem focus:ring-[#F46F23] focus:border-[#F46F23] pr-8 text-gray-900"
                                    value={
                                        newBarangData.id_kategori
                                            ? String(newBarangData.id_kategori)
                                            : ""
                  ...
                  ${
                      isDragging
                          ...
                          : "border-gray-300 hover:border-gray-400 hover:bg-blue-100"
                  }
                `}
                            ...
                            >
                                ...
                                {uploadedFile && uploadProgress === 100 ? (
                                    <>
                                        ...
                                        <p className="text-sm font-semibold text-gray-800 break-all text-center">
                                            {uploadedFile.name}
                                        </p>{" "}
                                        {/* Nama file */}
                                        {previewImageSrc && (
                                            <img
                                                src={previewImageSrc}
                                                alt="Preview"
                                                className="max-w-full h-24 object-contain rounded-sm shadow-sm border border-gray-200 mt-2"
                                                onError={(e) =>
                                                    (e.currentTarget.src =
                                  ...
                                  uploadProgress < 100 ? ( // Tampilan Saat Mengunggah
                                    <>
                                    ...
                                    <>
                                        ...
                                        <p className="text-sm font-medium">
                                            ...
                                            <span className="text-[#01529D] font-semibold">
                                                klik untuk memilih
                                            </span>
                                        </p>
