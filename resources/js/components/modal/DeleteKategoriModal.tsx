...
const DeleteKategoriModal: React.FC<Props> = ({
    isOpen,
    onClose,
    onSuccess,
    itemToDelete,
    ...
    const handleDelete = async () => {
        ...
        try {
            await axios.delete(
                `/api/admin/kategori/${itemToDelete.id_kategori}`
            );
            ...
            <div className="bg-white p-6 rounded-lg shadow-xl w-full max-w-sm">
                ...
                <div className="flex justify-end gap-3 pt-4 mt-4 border-t">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="px-4 py-2 bg-red-600 text-white rounded-sm flex items-center"
                    >
                        {isLoading && (
