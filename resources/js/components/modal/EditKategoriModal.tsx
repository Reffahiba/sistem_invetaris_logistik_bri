...
const EditKategoriModal: React.FC<Props> = ({
    isOpen,
    onClose,
    onSuccess,
    itemToEdit,
                ...
                <form onSubmit={handleSubmit} className="mt-4 space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-sm shadow-sm"
                            required
                        />
                    </div>
                    <div>
                        <label
                            htmlFor="deskripsi_edit"
                            className="block text-sm font-medium text-gray-700"
                        >
