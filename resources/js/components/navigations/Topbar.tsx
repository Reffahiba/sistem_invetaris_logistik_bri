        ...
        <header className="h-16 flex items-center justify-between px-4 shadow-sm bg-white border-b border-gray-200 sticky top-0 z-40">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="relative" ref={notificationRef}>
                    ...
                    {showNotifications && (
                        <div className="absolute right-0 mt-2 w-80 bg-white border border-gray-200 rounded-sm shadow-lg z-50">
                            <div className="px-4 py-3 border-b font-medium text-gray-800">
                                Notifikasi
                            </div>
                ...
                <div className="relative" ref={profileRef}>
                    ...
                    >
                        ...
                        <ChevronDownCircle
                            className={`w-4 h-4 text-gray-600 transition-transform duration-200 ml-1 ${
                                showProfile ? "rotate-180" : ""
                            }`}
                        />
                    </button>
                    {showProfile && (
                        <div className="absolute right-0 mt-2 w-64 bg-white border rounded-sm shadow-sm z-50">
                            ...
                            <ul className="text-sm text-gray-700 py-1">
                                <li className="flex items-center gap-2 px-4 py-2 hover:bg-gray-50 cursor-pointer">
                                    <UserCircle className="w-4 h-4" /> Edit
                                    profil
                                </li>
                                <li className="flex items-center gap-2 px-4 py-2 hover:bg-gray-50 cursor-pointer">
