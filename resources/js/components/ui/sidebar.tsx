            ...
            <SidebarContext.Provider value={contextValue}>
                <TooltipProvider delayDuration={0}>
                    <div
                        ...
                        className={cn(
                            "group/sidebar-wrapper flex min-h-svh has-[[data-variant=inset]]:bg-sidebar shadow-lg",
                            className
                        )}
                        ref={ref}
                        {...props}
    ...
    (
        ...
        if (collapsible === "none") {
            return (
                <div
                    className={cn(
                        "flex h-full w-[243px] flex-col bg-sidebar text-sidebar-foreground",
                        className
                    )}
                    ref={ref}
                    {...props}
...
>(({ className, ...props }, ref) => {
    return (
        <div
            ...
            data-sidebar="header"
            className={cn(
                "flex flex-col gap-2 shadow-sm border-r border-gray-200 outline-0 pb-1 justify-center items-center text-center",
                className
            )}
            {...props}
        />
...
const SidebarItem: React.FC<SidebarItemProps> = ({
    ...
    return (
        ...
        >
            ...
            />
            <a href={href} className="p-1 rounded text-sm pl-3">
                {label}
            </a>
        </div>
    );
